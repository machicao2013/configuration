...
yum install -y ncurses-devel ruby ruby-devel lua lua-devel luajit luajit-devel ctags mercurial python python-devel python3 \
    python3-devel tcl-devel perl perl-devel perl-ExtUtils-ParseXS perl-ExtUtils-XSpp perl-ExtUtils-CBuilder perl-ExtUtils-Embed cmake
...
cp -rf runtime/* ${INSTALL_DIR}

chown -R maxingsong:maxingsong ${INSTALL_DIR}

echo "export PATH=${INSTALL_DIR}/bin:$PATH" >> ${DST_HOME}/.bashrc
